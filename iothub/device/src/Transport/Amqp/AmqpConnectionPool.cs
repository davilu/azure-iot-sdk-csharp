...
namespace Microsoft.Azure.Devices.Client.Transport.Amqp
{
    internal class AmqpConnectionPool : IAmqpUnitManager
    {
        ...
        {
            if (Logger.IsEnabled) Logger.Enter(this, deviceIdentity, $"{nameof(ResolveConnectionByHashing)}");
            ...
            if (Logger.IsEnabled) Logger.Exit(this, deviceIdentity, $"{nameof(ResolveConnectionByHashing)}");
            return pool[index];
        }
    }
}

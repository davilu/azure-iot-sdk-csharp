...
namespace Microsoft.Azure.Devices.Client
{
    internal static class Logger
    {
        ...
        internal static readonly string s_logFilePath = Path.Combine(Path.GetTempPath(), "sdk.log");
        ...
        private static void WriteLog(string log)
        {
            ...
            lock (s_lock)
            {
                ...
                {
                    Console.WriteLine($"Log file: {s_logFilePath}");
#if NETSTANDARD1_3
...
#else
                    s_streamWriter = new StreamWriter(s_logFilePath, true);
#endif
                }
